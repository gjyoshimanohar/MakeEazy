        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-5 mb-10">
              ...
              <div>
                <h1 className="font-display text-3xl md:text-4xl font-bold text-slate-900">Limited Liability Partnership</h1>
                <p className="text-slate-500 font-medium mt-1">Partnership with limited liability protection</p>
              </div>
            </div>
            ...
            <div className="text-justify">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                A Limited Liability Partnership, or LLP, is a business structure where two or more partners run the business with limited liability protection. The LLP has a separate legal identity from its partners, which means the partners' personal assets are generally protected from business liabilities.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                LLPs are registered through the Ministry of Corporate Affairs. MCA-related LLP incorporation commonly involves name reservation, FiLLiP incorporation filing, DPIN/DIN for designated partners, and PAN/TAN allocation after approval.
              </p>

              <h2 className="text-2xl font-bold text-[#3150A0] mb-3 mt-8">How it is better than others</h2>
              
              <p className="text-slate-700 leading-relaxed mb-4">
                An LLP is better than a normal partnership because it provides limited liability protection. It is also generally easier to manage than a private limited company because it has fewer compliance requirements. Startup India notes that LLPs combine benefits of a company and partnership, including limited liability and a simpler structure.
              </p>

              <h2 className="text-2xl font-bold text-[#3150A0] mb-3 mt-8">Who should choose this model</h2>
              
              <p className="text-slate-700 leading-relaxed mb-4">
                This model is suitable for professional firms, consultants, service providers, agencies, small and medium businesses, and businesses that do not need equity funding from investors.
              </p>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Aadhaar cards/address proofs of partners",
                    "Passport-size photographs",
                    "Digital Signature Certificate of designated partners",
                    "DIN/DPIN details, if available",
