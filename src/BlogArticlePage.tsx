               ...
               {toc.length > 0 && (
                  <div className="hidden lg:block lg:col-span-4 xl:col-span-3 lg:sticky lg:top-28 space-y-4">
                     <div className="bg-slate-50/75 border border-slate-205 p-5 rounded-2xl shadow-xs">
                        <h3 className="text-[11px] font-extrabold uppercase tracking-widest text-[#3150A0] mb-3.5 flex items-center gap-2 border-b border-slate-200/80 pb-2.5">
                           <svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 6h16M4 12h16M4 18h7" />
                           </svg>
                           Table of Contents
                           ...
                           {toc.map((item) => (
                              <a
                                 ...
                                 className={`block text-xs leading-relaxed transition-all pl-3 border-l-2 py-0.5 hover:text-[#3150A0] text-left ${
                                    item.level === 3 ? 'ml-3 text-[11px] text-slate-450 font-medium' : 'text-slate-600 font-semibold'
                                 } ${
                                    activeId === item.id
                                       ? 'border-orange-500 text-[#3150A0] font-extrabold border-l-2'
