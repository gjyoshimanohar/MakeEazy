      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h1 className="font-display text-4xl font-bold text-[#3150A0] mb-4">
              Calculators
            </h1>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {calculators.map((calc, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-2xl ${calc.bg} ${calc.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
