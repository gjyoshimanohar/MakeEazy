...
import { Scale, ShieldAlert, FileWarning, Shield, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="font-display text-3xl md:text-4xl font-bold text-[#3150A0] leading-tight">Safeguarding Your Future</h1>
              <p className="text-slate-500 mt-1">The Power of Precision in Legal Documents</p>
            </div>
          </div>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="group relative bg-white border border-slate-200 rounded-3xl p-6 hover:shadow-xl hover:border-slate-300 transition-all cursor-pointer overflow-hidden flex flex-col text-left block">
                ...
                <h3 className="font-display text-xl font-bold text-[#3150A0] mb-2 group-hover:text-orange-500 transition-colors">Risk Mitigation</h3>
              ...
              <div className="group relative bg-white border border-slate-200 rounded-3xl p-6 hover:shadow-xl hover:border-slate-300 transition-all cursor-pointer overflow-hidden flex flex-col text-left block">
                ...
                <h3 className="font-display text-xl font-bold text-[#3150A0] mb-2 group-hover:text-orange-500 transition-colors">Regulatory Alignment</h3>
                <p className="text-sm text-slate-600 leading-normal text-justify">
              ...
              <div className="group relative bg-white border border-slate-200 rounded-3xl p-6 hover:shadow-xl hover:border-slate-300 transition-all cursor-pointer overflow-hidden flex flex-col text-left block">
                ...
                <h3 className="font-display text-xl font-bold text-[#3150A0] mb-2 group-hover:text-orange-500 transition-colors">Protecting Financial Interests</h3>
                <p className="text-sm text-slate-600 leading-normal text-justify">
              ...
              <table className="w-full text-left border-collapse bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-200">
                <thead>
                  <tr className="bg-[#3150A0] text-white">
                    ...
                    <th className="py-4 px-6 font-semibold uppercase tracking-wider text-sm border-l border-white/20">Generic Templates</th>
                    <th className="py-4 px-6 font-semibold uppercase tracking-wider text-sm border-l border-white/20">Custom Drafting</th>
                  </tr>
                </thead>
                <tbody className="text-slate-700 divide-y divide-slate-200">
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="py-4 px-6 font-bold text-[#3150A0] border-r border-slate-200">Protection</td>
                    <td className="py-4 px-6 border-r border-slate-200 text-orange-600 font-medium">Leaves operational and legal loopholes open</td>
                    <td className="py-4 px-6"><div className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" /><span>Closes specific liability gaps</span></div></td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="py-4 px-6 font-bold text-[#3150A0] border-r border-slate-200">Compliance</td>
                    <td className="py-4 px-6 border-r border-slate-200 text-orange-600 font-medium">Often outdated or region-agnostic</td>
                    <td className="py-4 px-6"><div className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" /><span>Aligned with current corporate and tax frameworks</span></div></td>
                  </tr>
                  <tr className="hover:bg-slate-50 transition-colors">
                    <td className="py-4 px-6 font-bold text-[#3150A0] border-r border-slate-200">Clarity</td>
                    <td className="py-4 px-6 border-r border-slate-200 text-orange-600 font-medium">Broad, vague terms open to interpretation</td>
                    <td className="py-4 px-6"><div className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" /><span>Precise definitions tailored to your exact transaction</span></div></td>
                  </tr>
                </tbody>
              </table>
            </div>
