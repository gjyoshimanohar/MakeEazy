...
const TESTIMONIALS = [
  {
    ...
    content: "MakeEazy completely handled our complex GST issues and compliance audits. Their proactive approach saved us penalties and gave us total peace of mind.",
    rating: 5
  },
  {
    name: "Ravi Shankar",
    role: "Founder, GreenLeaf Retail",
    content: "The expertise of the MakeEazy team in ROC matters is unmatched. They streamlined our annual filings and provided fantastic consultancy.",
    rating: 5
  },
  {
    name: "Ananya Desai",
    role: "Director, BuildCorp",
    content: "We moved our entire accounting over to MakeEazy. They are responsive, deeply knowledgeable, and our financial health has never been better tracked.",
    rating: 5
  },
];
    ...
    <div className="flex relative md:absolute md:top-28 lg:top-36 md:right-8 lg:right-12 xl:right-16 flex-col items-start gap-3 z-30 px-4 md:px-0 mb-8 md:mb-0 w-full md:w-auto order-2 md:order-none">
      ...
      >
        <div className="flex items-center justify-center gap-1.5">
          ...
          <span className="font-extrabold text-[#ea580c] text-[15px] leading-tight group-hover:text-orange-600">68 Days left to File your ITR</span>
        </div>
        <span className="text-slate-500 text-xs font-semibold">Deadline: July 31, 2026</span>
      </a>
    </div>
  );
}
...
function Hero() {
  return (
    <section id="home" className="pt-24 pb-6 lg:pt-32 lg:pb-10 overflow-hidden bg-slate-50 relative flex flex-col md:block">
      <TopRightCountdown />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="font-display text-[44px] md:text-[50px] lg:text-6xl font-extrabold text-[#3150A0] leading-[44px] md:leading-[1.1] lg:leading-[1.1] tracking-tight mb-6">
              <span className="inline-block whitespace-nowrap">Hi, Welcome to</span> <br />
            ...
            <p className="text-[16px] md:text-lg text-slate-600 mb-8 max-w-xl leading-[22.5px] md:leading-normal text-justify">
              We support Entrepreneurs from Start to Finish with our Expert services in Audit, Accountancy, Taxation, and compliance. Focus on your vision while we manage your business growth.
            </p>
            ...
            <div className="mt-12 flex flex-wrap items-center gap-8 text-sm font-medium text-slate-500">
              <div className="flex flex-col">
                <span className="font-display text-2xl font-bold text-slate-900">5+</span>
                <span>Years Experience</span>
              </div>
              <div className="w-px h-10 bg-slate-200" />
              <div className="flex flex-col">
                <span className="font-display text-2xl font-bold text-slate-900">500+</span>
                <span>Clients Empowered</span>
              </div>
              <div className="w-px h-10 bg-slate-200" />
              <div className="flex flex-col">
                <span className="font-display text-2xl font-bold text-slate-900">15+</span>
...
const SLIDES = [
  {
    ...
    subtitle: 'Streamline detailed GST audits, ITR filings, and customized computational books.',
    color: 'from-orange-500 to-red-500',
    illustrations: (
      <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-md">
         <circle cx="250" cy="200" r="150" stroke="#FFEFE2" strokeWidth="3" />
         <circle cx="250" cy="200" r="110" stroke="#FFF7ED" strokeWidth="2" strokeDasharray="5 5" />

         <g transform="translate(170, 90)" filter="drop-shadow(0 15px 30px rgba(234,88,12,0.1))">
           <rect width="160" height="195" rx="12" fill="white" stroke="#F97316" strokeWidth="3" />
           <rect width="160" height="30" rx="8" fill="#F97316" />
           <text x="80" y="19" textAnchor="middle" fontSize="11" fontWeight="bold" fill="white">INCOME TAX RETURN</text>
           
           <g transform="translate(15, 50)">
             <text x="0" y="10" fontSize="9" fontWeight="bold" fill="#64748B">FY 2025-26 Status</text>
             <rect x="0" y="18" width="130" height="6" rx="3" fill="#FFEFE2" />
             <rect x="0" y="18" width="105" height="6" rx="3" fill="#EA580C" />
           </g>
           <g transform="translate(15, 90)">
             <text x="0" y="10" fontSize="9" fontWeight="bold" fill="#64748B">ITR filing review</text>
             <rect x="0" y="18" width="130" height="6" rx="3" fill="#D1FAE5" />
             <rect x="0" y="18" width="130" height="6" rx="3" fill="#10B981" />
           </g>
           <g transform="translate(15, 130)">
             <text x="0" y="10" fontSize="9" fontWeight="bold" fill="#64748B">Deductions</text>
             <text x="130" y="10" textAnchor="end" fontSize="10" fontWeight="extrabold" fill="#047857">₹46,200 saved</text>
             <line x1="0" y1="18" x2="130" y2="18" stroke="#E2E8F0" strokeWidth="1" />
           </g>
           <g transform="translate(100, 145)">
             <circle cx="15" cy="15" r="15" fill="#34D399" />
             <path d="M 9 15 L 13 19 L 21 11" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
           </g>
         </g>

         <g transform="translate(45, 130)" filter="drop-shadow(0 6px 12px rgba(0,0,0,0.05))">
           <rect width="90" height="135" rx="10" fill="white" stroke="#E2E8F0" strokeWidth="2" />
           <rect x="10" y="10" width="70" height="25" rx="4" fill="#1E293B" />
           <text x="70" y="27" textAnchor="end" fontSize="13" fontWeight="bold" fill="#34D399" fontFamily="monospace">₹ 84,500</text>
         ...
         <g transform="translate(365, 120)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="90" height="110" rx="10" fill="white" stroke="#EA580C" strokeWidth="1.5" />
           <rect width="90" height="20" rx="4" fill="#EF4444" />
           <text x="45" y="14" textAnchor="middle" fontSize="9" fontWeight="bold" fill="white">REGULATORY</text>
           <text x="45" y="50" textAnchor="middle" fontSize="24" fontWeight="extrabold" fill="#1E293B">31</text>
           <text x="45" y="68" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#EF4444">JULY DUE TIME</text>
           <rect x="15" y="80" width="60" height="15" rx="2" fill="#FEF3C7" />
           <text x="45" y="90" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#B45309">ITR ON TIME</text>
         </g>
      </svg>
    )
  },
  {
    ...
    subtitle: 'End-to-end tax filings, audit trails, and automated regulatory review.',
    color: 'from-blue-600 to-indigo-600',
    illustrations: (
      <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-md">
         {/* Background Orbits */}
         <circle cx="250" cy="200" r="140" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="6 6" />
         <circle cx="250" cy="200" r="185" stroke="#F1F5F9" strokeWidth="1.5" />
         <path d="M 120 120 Q 250 100 380 120 T 250 360 Z" stroke="#FDBA74" strokeWidth="2" strokeDasharray="4 8" fill="none" opacity="0.6" />

         {/* Central circular banner */}
         <g filter="drop-shadow(0 10px 15px rgba(0,0,0,0.05))">
           <circle cx="250" cy="200" r="85" fill="#FFFFFF" stroke="#E2E8F0" strokeWidth="2" />
           <circle cx="250" cy="200" r="80" fill="url(#centerGrad)" />
           {/* Center Text */}
           <text x="250" y="190" textAnchor="middle" fill="#FFFFFF" fontSize="13" fontWeight="bold" fontFamily="system-ui">Compliance &</text>
           <text x="250" y="210" textAnchor="middle" fill="#FFFFFF" fontSize="13" fontWeight="bold" fontFamily="system-ui">Regulatory Support</text>
         ...
         <g transform="translate(80, 70)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect x="0" y="0" width="100" height="120" rx="10" fill="white" stroke="#FEF3C7" strokeWidth="2" />
           {/* Folded corner */}
           <path d="M 80 0 L 100 20 L 80 20 Z" fill="#FDE68A" />
           <text x="50" y="25" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#1E3A8A">TAX FILING</text>
           <g transform="translate(15, 42)">
             <circle cx="10" cy="10" r="7" fill="#D1FAE5" />
             <path d="M 7 10 L 9 12 L 13 8" stroke="#10B981" strokeWidth="1.5" strokeLinecap="round" />
           ...
           <path d="M 25 100 Q 35 95 45 102 T 65 98" stroke="#3150A0" strokeWidth="1.5" fill="none" opacity="0.6" />
           <circle cx="85" cy="100" r="14" fill="#34D399" />
           <path d="M 79 100 L 83 104 L 91 96" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
         </g>

         {/* 2. Simple TAX slip (Top Center) */}
         <g transform="translate(210, 20)" filter="drop-shadow(0 6px 12px rgba(0,0,0,0.04))">
           <rect x="0" y="0" width="55" height="40" rx="5" fill="#FFFFFF" stroke="#FDBA74" strokeWidth="1" />
           <rect x="0" y="0" width="55" height="8" rx="2" fill="#FFEFE2" />
           <text x="27.5" y="22" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#EA580C">TAX</text>
           <rect x="10" y="28" width="35" height="3" rx="1.5" fill="#E2E8F0" />
         </g>

         {/* 3. Audit Doc (Right Top) */}
         <g transform="translate(330, 60)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect x="0" y="0" width="95" height="115" rx="10" fill="white" stroke="#DBEAFE" strokeWidth="2" />
           <path d="M 75 0 L 95 20 L 75 20 Z" fill="#BFDBFE" />
           <text x="47.5" y="25" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#1E3A8A">AUDIT</text>
           ...
           <circle cx="75" cy="95" r="8" stroke="#3B82F6" strokeWidth="1.5" strokeDasharray="2 2" fill="none" />
         </g>

         {/* 4. Financial Analytics Chart (Right Bottom) */}
         <g transform="translate(350, 215)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect x="0" y="0" width="115" height="115" rx="12" fill="white" stroke="#FEF3C7" strokeWidth="1" />
           <text x="57.5" y="20" textAnchor="middle" fontSize="11" fontWeight="extrabold" fill="#ea580c">AUDIT</text>
         ...
         <g transform="translate(190, 310)" filter="drop-shadow(0 4px 8px rgba(0,0,0,0.045))">
           <rect x="0" y="0" width="80" height="50" rx="6" fill="#FFFFFF" stroke="#E2E8F0" strokeWidth="1.5" />
           <text x="40" y="20" textAnchor="middle" fontSize="9" fontWeight="bold" fill="#64748B">SERVICES</text>
           <line x1="15" y1="28" x2="65" y2="28" stroke="#CBD5E1" strokeWidth="2" strokeLinecap="round" />
           <line x1="15" y1="36" x2="50" y2="36" stroke="#CBD5E1" strokeWidth="2" strokeLinecap="round" />
         </g>

         {/* 6. Legal / Coniee checklist (Left Bottom) */}
         <g transform="translate(60, 225)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect x="0" y="0" width="95" height="115" rx="10" fill="white" stroke="#E2E8F0" strokeWidth="2" />
           <text x="47.5" y="22" textAnchor="middle" fontSize="11" fontWeight="bold" fill="#1E3A8A">CHECKLIST</text>
           <g transform="translate(12, 38)">
             <rect x="0" y="0" width="10" height="10" rx="2" fill="#DBEAFE" />
             <path d="M 2 5 L 4 7 L 8 3" stroke="#2563EB" strokeWidth="1.5" strokeLinecap="round" fill="none" />
           ...
           <path d="M 71 95 L 74 98 L 79 93" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
         </g>
  ...
  },
  {
    ...
    subtitle: 'Hassle-free business incorporation, GST setups, and MSME recognitions.',
    color: 'from-orange-500 to-amber-500',
    illustrations: (
      <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-md">
         <line x1="50" y1="200" x2="450" y2="200" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="8 8" />
         <circle cx="250" cy="200" r="120" stroke="#DBEAFE" strokeWidth="2" strokeDasharray="4 4" />

         {/* Rocket doodle */}
         <g transform="translate(200, 110)">
           <ellipse cx="50" cy="160" rx="60" ry="15" fill="#E2E8F0" opacity="0.6" />
           <ellipse cx="50" cy="155" rx="40" ry="12" fill="#CBD5E1" opacity="0.8" />
           <path d="M 50 20 C 65 50 65 110 58 130 L 42 130 C 35 110 35 50 50 20 Z" fill="#F1F5F9" stroke="#94A3B8" strokeWidth="2" />
           <path d="M 50 20 C 58 35 55 50 50 50 C 45 50 42 35 50 20 Z" fill="#F97316" />
           ...
           <circle cx="50" cy="70" r="8" fill="#E0F2FE" stroke="#94A3B8" strokeWidth="1.5" />
           <circle cx="50" cy="70" r="5" fill="#38BDF8" />
         </g>

         {/* MSME details */}
         <g transform="translate(60, 60)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="90" height="110" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="2" />
           <rect width="90" height="15" rx="4" fill="#FFF7ED" />
           <text x="45" y="11" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#EA580C">MSME CERT</text>
           <line x1="15" y1="35" x2="75" y2="35" stroke="#E2E8F0" strokeWidth="2.5" strokeLinecap="round" />
           <line x1="15" y1="50" x2="75" y2="50" stroke="#E2E8F0" strokeWidth="2.5" strokeLinecap="round" />
           <line x1="15" y1="65" x2="60" y2="65" stroke="#E2E8F0" strokeWidth="2.5" strokeLinecap="round" />
           <circle cx="70" cy="85" r="10" fill="#10B981" />
           <path d="M 66 85 L 69 88 L 74 83" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
         </g>

         {/* Incorporation Cert top right */}
         <g transform="translate(340, 50)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="100" height="120" rx="8" fill="white" stroke="#DBEAFE" strokeWidth="2" />
           <rect width="100" height="18" rx="4" fill="#EFF6FF" />
           <text x="50" y="12" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#1E40AF">GST REGISTRATION</text>
           ...
           <path d="M 30 100 Q 50 90 70 100" stroke="#3150A0" strokeWidth="1.5" fill="none" />
           <circle cx="75" cy="95" r="11" fill="none" stroke="#34D399" strokeWidth="2" />
           <path d="M 71 95 L 74 98 L 79 93" stroke="#34D399" strokeWidth="2" strokeLinecap="round" fill="none" />
         </g>
         
         <g transform="translate(60, 260)" filter="drop-shadow(0 6px 12px rgba(0,0,0,0.04))">
           <rect width="90" height="60" rx="8" fill="white" stroke="#34D399" strokeWidth="1.5" />
           <text x="45" y="22" textAnchor="middle" fontSize="9" fontWeight="bold" fill="#047857">PAN Card</text>
           <rect x="15" y="32" width="60" height="5" rx="2.5" fill="#E2E8F0" />
           <rect x="15" y="44" width="40" height="5" rx="2.5" fill="#E2E8F0" />
         </g>
         
         <g transform="translate(340, 250)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="100" height="70" rx="10" fill="#3150A0" />
           <text x="50" y="25" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#FFF">INCORPORATION</text>
           <text x="50" y="45" textAnchor="middle" fontSize="14" fontWeight="extrabold" fill="#FBBF24">100% DONE</text>
           <rect x="20" y="54" width="60" height="4" rx="2" fill="white" opacity="0.3" />
  ...
  },
  {
    ...
    subtitle: 'Thorough auditing, GAAP-aligned double entry ledgers and tax reserves compilation.',
    color: 'from-blue-600 to-sky-600',
    illustrations: (
      <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-md">
         <path d="M 50 100 L 450 100 M 50 200 L 450 200 M 50 300 L 450 300" stroke="#F1F5F9" strokeWidth="1.5" />
         <path d="M 100 50 L 100 350 M 200 50 L 200 350 M 300 50 L 300 350 M 400 50 L 400 350" stroke="#F1F5F9" strokeWidth="1.5" />

         <g transform="translate(180, 100)" filter="drop-shadow(0 15px 30px rgba(0,0,0,0.08))">
           <rect width="140" height="180" rx="12" fill="#FFFFFF" stroke="#3150A0" strokeWidth="3" />
           <rect width="140" height="25" rx="6" fill="#3150A0" />
           <text x="70" y="16" textAnchor="middle" fontSize="9" fontWeight="bold" fill="#FFFFFF">BUSINESS LEDGER</text>
           
           <g transform="translate(15, 45)">
             <text x="0" y="10" fontSize="10" fontWeight="bold" fill="#64748B">Balance audit</text>
             <text x="110" y="10" fontSize="10" textAnchor="end" fontWeight="bold" fill="#10B981">₹9,450</text>
             <line x1="0" y1="18" x2="110" y2="18" stroke="#F1F5F9" strokeWidth="1" />
           </g>
           <g transform="translate(15, 75)">
             <text x="0" y="10" fontSize="10" fontWeight="bold" fill="#64748B">Asset appraisal</text>
             <text x="110" y="10" fontSize="10" textAnchor="end" fontWeight="bold" fill="#10B981">₹14,200</text>
             <line x1="0" y1="18" x2="110" y2="18" stroke="#F1F5F9" strokeWidth="1" />
           </g>
           <g transform="translate(15, 105)">
             <text x="0" y="10" fontSize="10" fontWeight="bold" fill="#64748B">Tax reserves</text>
             <text x="110" y="10" fontSize="10" textAnchor="end" fontWeight="bold" fill="#3150A0">Verified</text>
             <line x1="0" y1="18" x2="110" y2="18" stroke="#F1F5F9" strokeWidth="1" />
           </g>
           
           <g transform="translate(85, 130)">
             <circle cx="15" cy="15" r="18" fill="#F97316" />
             <path d="M 8 15 L 12 19 L 22 9" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
           </g>
         </g>

         <g transform="translate(360, 110)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect width="90" height="150" rx="10" fill="white" stroke="#FEF3C7" strokeWidth="1" />
           <text x="45" y="20" textAnchor="middle" fontSize="11" fontWeight="extrabold" fill="#EA580C">REPORTS</text>
           ...
           <text x="45" y="138" textAnchor="middle" fontSize="7" fontWeight="bold" fill="#047857">GAAP CERTIFIED</text>
         </g>

         <g transform="translate(50, 120)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="90" height="120" rx="12" fill="white" stroke="#DBEAFE" strokeWidth="1.5" />
           ...
           <text x="45" y="80" textAnchor="middle" fontSize="10" fontWeight="extrabold" fill="#1E40AF">ACCURACY</text>
           <text x="45" y="100" textAnchor="middle" fontSize="12" fontWeight="extrabold" fill="#10B981">99.9%</text>
         </g>
      </svg>
    )
  },

  {
    ...
    subtitle: 'Expert contract drafting, secure Partnership Deeds, and robust NDA agreements.',
    color: 'from-blue-700 to-indigo-800',
    illustrations: (
      <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-md">
         <circle cx="250" cy="200" r="140" stroke="#DBEAFE" strokeWidth="2" strokeDasharray="10 5" />
         
         <g transform="translate(160, 80)" filter="drop-shadow(0 15px 30px rgba(0,0,0,0.08))">
           <rect width="180" height="230" rx="12" fill="white" stroke="#3150A0" strokeWidth="3" />
           <rect x="25" y="25" width="130" height="25" rx="4" fill="#D97706" />
           <text x="90" y="41" textAnchor="middle" fontSize="10" fontWeight="extrabold" fill="white">PARTNERSHIP DEED</text>
           
           <g transform="translate(25, 75)">
             <line x1="0" y1="0" x2="130" y2="0" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
             <line x1="0" y1="12" x2="110" y2="12" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
             <line x1="0" y1="36" x2="130" y2="36" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
             <line x1="0" y1="48" x2="95" y2="48" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
             <line x1="0" y1="72" x2="130" y2="72" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
             <line x1="0" y1="84" x2="120" y2="84" stroke="#E2E8F0" strokeWidth="4" strokeLinecap="round" />
           </g>

           <g transform="translate(115, 175)">
             <circle cx="15" cy="15" r="16" fill="#FBBF24" />
             <circle cx="15" cy="15" r="12" stroke="white" strokeWidth="1" strokeDasharray="3 3" fill="none" />
             <path d="M 8 25 L 12 40 L 16 30 L 20 40 L 24 25" fill="#EF4444" stroke="#B91C1C" strokeWidth="1" />
           </g>

           <g transform="translate(25, 185)">
             <path d="M 0 10 Q 15 0 25 15 T 45 5" stroke="#3150A0" strokeWidth="2" fill="none" />
             <line x1="0" y1="18" x2="45" y2="18" stroke="#CBD5E1" strokeWidth="1" />
             <text x="0" y="26" fontSize="6" fill="#94A3B8" fontWeight="bold">FIRST PARTY</text>
           </g>
           
           <g transform="translate(80, 185)">
             <path d="M 0 5 Q 10 15 20 5 T 35 12" stroke="#3150A0" strokeWidth="2" fill="none" />
             <line x1="0" y1="18" x2="35" y2="18" stroke="#CBD5E1" strokeWidth="1" />
             <text x="0" y="26" fontSize="6" fill="#94A3B8" fontWeight="bold">SECOND PARTY</text>
           </g>
         </g>

         <g transform="translate(45, 130)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.06))">
           <rect width="85" height="110" rx="10" fill="white" stroke="#FEF3C7" strokeWidth="1" />
           <g transform="translate(12, 12)">
             <line x1="30" y1="15" x2="30" y2="75" stroke="#D97706" strokeWidth="5" strokeLinecap="round" />
             <circle cx="30" cy="12" r="6" fill="#D97706" />
             <line x1="10" y1="28" x2="50" y2="28" stroke="#D97706" strokeWidth="4" strokeLinecap="round" />
             <line x1="12" y1="30" x2="4" y2="55" stroke="#CBD5E1" strokeWidth="1.5" />
             <line x1="12" y1="30" x2="20" y2="55" stroke="#CBD5E1" strokeWidth="1.5" />
             <path d="M 0 55 C 4 64 20 64 24 55 Z" fill="#F1F5F9" stroke="#94A3B8" strokeWidth="1.5" />
             <line x1="48" y1="30" x2="40" y2="55" stroke="#CBD5E1" strokeWidth="1.5" />
             <line x1="48" y1="30" x2="56" y2="55" stroke="#CBD5E1" strokeWidth="1.5" />
             <path d="M 36 55 C 40 64 56 64 60 55 Z" fill="#F1F5F9" stroke="#94A3B8" strokeWidth="1.5" />
             <rect x="15" y="75" width="30" height="8" rx="2" fill="#D97706" />
           </g>
         </g>

         <g transform="translate(370, 130)" filter="drop-shadow(0 8px 16px rgba(0,0,0,0.05))">
           <rect width="90" height="110" rx="10" fill="white" stroke="#DBEAFE" strokeWidth="1.5" />
           <g transform="translate(25, 20)">
             <path d="M 12 25 L 12 15 C 12 5 28 5 28 15 L 28 25" stroke="#3150A0" strokeWidth="5" fill="none" strokeLinecap="round" />
             <rect x="0" y="24" width="40" height="32" rx="6" fill="#F59E0B" stroke="#D97706" strokeWidth="2.5" />
             <circle cx="20" cy="38" r="4" fill="#D97706" />
             <line x1="20" y1="42" x2="20" y2="48" stroke="#D97706" strokeWidth="3" strokeLinecap="round" />
           </g>
           <text x="45" y="90" textAnchor="middle" fontSize="10" fontWeight="extrabold" fill="#1E40AF">SECURE NDA</text>
         </g>
      </svg>
    )
  }
...
export const ConsultantDeskIllustration = () => (
  <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full max-w-lg drop-shadow-xl relative z-10">
    <circle cx="250" cy="200" r="160" fill="#E0F2FE" opacity="0.6" />
    <path d="M120 320Q 250 150 380 320" stroke="#BAE6FD" strokeWidth="8" fill="none" strokeDasharray="12 12" opacity="0.5"/>
    <path d="M120 280C 110 250 90 230 70 230C 90 230 110 240 120 260C 130 240 150 230 170 230C 150 230 130 250 120 280Z" fill="#10B981" />
    <path d="M110 250C 100 220 80 200 60 200C 80 200 100 210 110 230C 120 210 140 200 160 200C 140 200 120 220 110 250Z" fill="#34D399" />
    <path d="M95 280L 145 280L 135 340L 105 340Z" fill="#FCD34D" />
    <rect x="280" y="80" width="140" height="100" rx="8" fill="white" filter="drop-shadow(0 4px 6px rgb(0 0 0 / 0.05))" />
    <path d="M290 150L 320 130L 350 140L 380 100L 410 110" stroke="#F97316" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    ...
    <g transform="translate(190, 110)">
      ...
      <path d="M20 120 C 20 80 100 80 100 120 L 120 170 L 0 170 Z" fill="#1E3A8A" />
      <path d="M30 120 L 10 170" stroke="#1E40AF" strokeWidth="18" strokeLinecap="round" />
      <path d="M90 120 L 130 160" stroke="#1E40AF" strokeWidth="18" strokeLinecap="round" />
    </g>
    ...
    <path d="M236 255 Q 244 255 244 260 Q 244 265 236 265" stroke="white" strokeWidth="3" fill="none" strokeLinecap="round" />
    ...
    <g transform="translate(370, 268) rotate(15)">
      <rect x="0" y="0" width="35" height="45" fill="#F8FAFC" opacity="0.9" stroke="#E2E8F0" />
...
const MeetingIllustration = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
    {/* Dynamic Background elements */}
    <circle cx="200" cy="180" r="140" fill="#DBEAFE" opacity="0.5" />
    <path d="M80 280Q 200 150 320 280" stroke="#BFDBFE" strokeWidth="6" fill="none" strokeDasharray="10 10" opacity="0.6"/>
    ...
    <rect x="180" y="240" width="40" height="25" rx="3" fill="#FFFFFF" opacity="0.9" />
    ...
    <path d="M120 100 Q 120 70 150 70 Q 180 70 180 100 Q 180 130 150 130 L 140 140 L 140 130 Q 120 130 120 100 Z" fill="#FFFFFF" filter="drop-shadow(0 4px 3px rgb(0 0 0 / 0.07))" />
    <circle cx="140" cy="100" r="4" fill="#94A3B8" />
    <circle cx="150" cy="100" r="4" fill="#CBD5E1" />
    <circle cx="160" cy="100" r="4" fill="#E2E8F0" />
    
    <path d="M260 130 Q 260 100 290 100 Q 320 100 320 130 Q 320 160 290 160 L 280 170 L 280 160 Q 260 160 260 130 Z" fill="#FFEDD5" filter="drop-shadow(0 4px 3px rgb(0 0 0 / 0.07))" />
    <line x1="275" y1="125" x2="305" y2="125" stroke="#FDBA74" strokeWidth="4" strokeLinecap="round" />
    <line x1="275" y1="135" x2="295" y2="135" stroke="#FDBA74" strokeWidth="4" strokeLinecap="round" />
  </svg>
);
...
const FinanceIllustration = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
    ...
    {/* Chart Board */}
    <rect x="80" y="50" width="240" height="160" rx="12" fill="#FFFFFF" filter="drop-shadow(0 10px 8px rgb(0 0 0 / 0.04))" />
    <rect x="80" y="50" width="240" height="160" rx="12" stroke="#FDBA74" strokeWidth="4" />
    
    <path d="M100 180L 140 120L 180 140L 230 70L 280 90L 300 40" stroke="#F97316" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    ...
    {/* Laptop */}
    <rect x="230" y="240" width="80" height="55" rx="5" fill="#1E293B" transform="rotate(-15 230 240)" />
    <rect x="245" y="247" width="65" height="40" rx="3" fill="#F8FAFC" transform="rotate(-15 230 240)" />
    <path d="M200 290L 330 290L 320 280L 215 280Z" fill="#334155" />
    
    {/* Floating Elements */}
    <circle cx="120" cy="240" r="16" fill="#FFFFFF" filter="drop-shadow(0 4px 3px rgb(0 0 0 / 0.07))" />
    <path d="M115 240 L 125 240 M120 235 L 120 245" stroke="#10B981" strokeWidth="4" strokeLinecap="round" />
    
    <circle cx="340" cy="180" r="12" fill="#FFFFFF" filter="drop-shadow(0 4px 3px rgb(0 0 0 / 0.07))" />
  </svg>
);
...
const BusinessSuccessIllustration = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
    ...
    {/* Growth Arrow Base */}
    <path d="M70 300 Q 150 300 200 200 T 310 80" stroke="#818CF8" strokeWidth="12" strokeLinecap="round" fill="none" opacity="0.4" strokeDasharray="10 10"/>
    <path d="M70 300 Q 150 300 200 200 T 310 80" stroke="#4F46E5" strokeWidth="6" strokeLinecap="round" fill="none" />
    <path d="M280 80 L 310 80 L 310 110" stroke="#4F46E5" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    ...
    {/* Trophy Handles */}
    <path d="M140 160 C 100 160 100 220 160 220" stroke="#F59E0B" strokeWidth="12" strokeLinecap="round" fill="none" />
    <path d="M260 160 C 300 160 300 220 240 220" stroke="#F59E0B" strokeWidth="12" strokeLinecap="round" fill="none" />
    <path d="M140 160 C 100 160 100 220 160 220" stroke="#FEF3C7" strokeWidth="4" strokeLinecap="round" fill="none" />
    <path d="M260 160 C 300 160 300 220 240 220" stroke="#FEF3C7" strokeWidth="4" strokeLinecap="round" fill="none" />

    {/* Sparkles / Stars */}
    <path d="M200 60 L 205 85 L 230 90 L 205 95 L 200 120 L 195 95 L 170 90 L 195 85 Z" fill="#FDE68A" />
    <path d="M100 100 L 103 115 L 118 118 L 103 121 L 100 136 L 97 121 L 82 118 L 97 115 Z" fill="#FDE68A" />
    <path d="M300 180 L 302 190 L 312 192 L 302 194 L 300 204 L 298 194 L 288 192 L 298 190 Z" fill="#FDE68A" />
    
    {/* Highlighting on cup */}
    <path d="M170 150 C 170 210 200 230 200 230 C 200 230 150 200 150 150 Z" fill="#FEF3C7" opacity="0.6" />
...
const TrustIllustration = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-md">
    ...
    {/* Shield of Trust */}
    <path d="M200 80 L 280 110 L 280 200 C 280 260 200 320 200 320 C 200 320 120 260 120 200 L 120 110 Z" fill="#3B82F6" />
    <path d="M200 80 L 280 110 L 280 200 C 280 260 200 320 200 320 Z" fill="#2563EB" />
    
    {/* Checkmark inside shield */}
    <path d="M160 200 L 190 230 L 250 150" stroke="#FFFFFF" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" />
    
    {/* Connection/Trust nodes around */}
    <path d="M120 140 L 80 160" stroke="#BFDBFE" strokeWidth="6" strokeLinecap="round" />
    <circle cx="80" cy="160" r="10" fill="#60A5FA" />
    
    <path d="M280 140 L 320 160" stroke="#BFDBFE" strokeWidth="6" strokeLinecap="round" />
    <circle cx="320" cy="160" r="10" fill="#60A5FA" />

    {/* Sparkles */}
    <path d="M100 80 L 105 95 L 120 100 L 105 105 L 100 120 L 95 105 L 80 100 L 95 95 Z" fill="#FDBA74" />
    <path d="M300 80 L 305 95 L 320 100 L 305 105 L 300 120 L 295 105 L 280 100 L 295 95 Z" fill="#FDBA74" />
  </svg>
);

function About() {
  return (
    <section id="about-us" className="py-8 lg:py-12 bg-white relative overflow-hidden">
      {/* Background Decorative Elements */}
      <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 relative z-10 scale-[0.85] origin-center">
              <div className="space-y-4 pt-12">
                ...
                <div className="bg-orange-100 rounded-3xl p-6 shadow-lg flex flex-col justify-center items-center text-center aspect-[4/3] border border-orange-200">
                  <span className="font-display text-4xl font-extrabold text-orange-600 mb-2">5+</span>
                  <span className="text-sm font-semibold text-orange-800 uppercase tracking-widest">Years of Trust</span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-3xl p-6 shadow-lg flex flex-col justify-center items-center text-center aspect-[4/3] border border-blue-100">
                  <span className="font-display text-4xl font-extrabold text-blue-600 mb-2">500+</span>
                  <span className="text-sm font-semibold text-blue-800 uppercase tracking-widest">Clients Empowered</span>
                </div>
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-normal mb-10 text-justify">
              We support entrepreneurs from start to finish with our expert services in Audit, Accountancy, Taxation, and compliance. Our experienced team is dedicated to handling the complexities of regulatory requirements, enabling businesses and individuals to focus purely on what they do best—innovating and growing.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex gap-5">
                ...
                <div>
                  <h4 className="text-xl font-bold text-[#3150A0] mb-2">Our Mission</h4>
                  <p className="text-slate-600 leading-normal text-justify">
                    To deliver accurate, timely, and seamless accounting and compliance solutions that act as a catalyst for our clients' business success and financial health.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h4 className="text-xl font-bold text-[#3150A0] mb-2">Our Vision</h4>
                  <p className="text-slate-600 leading-normal text-justify">
                    To be the most trusted and preferred partner for businesses across India, recognized for transforming complex compliance into effortless growth opportunities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-slate-700">Expert Team</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-500" />
                <span className="font-semibold text-slate-700">End-to-End Support</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-500" />
                <span className="font-semibold text-slate-700">100% Compliant</span>
              </div>
            </div>
...
function Services() {
  return (
    <section id="services" className="py-8 lg:py-10 bg-slate-50 border-y border-slate-100 relative overflow-hidden">
      {/* Background Decorative Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8">
          <h2 className="font-display text-4xl lg:text-5xl font-bold text-[#3150A0] tracking-tight mb-4">
            Grow your Business <br className="hidden sm:block" /> with our Services
          </h2>
          <p className="text-lg text-slate-500 text-justify">
            Our top priority is to provide effective solutions tailored to your unique business needs across all compliance and regulatory domains.
          </p>
        </div>
...
function Testimonials() {
  return (
    <section id="testimonials" className="py-8 lg:py-10 bg-white border-y border-slate-100 relative overflow-hidden">
      {/* Background Decorative Elements */}
      <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="text-lg text-slate-500 text-justify sm:text-center">
            See how our tailored financial solutions have helped businesses streamline their compliance and growth strategies.
          </p>
        </div>
...
function FAQ() {
  ...
  const faqs = [
    {
      question: "What is the threshold limit of turnover for GST registration in India?",
      answer: "GST registration is mandatory if your aggregate annual turnover exceeds ₹40 Lakhs for goods suppliers (exemption limit is ₹20 Lakhs for Special Category States in Northeast and hill regions) or ₹20 Lakhs for services providers (₹10 Lakhs for Special Category States)."
    },
    {
      question: "What are the rules and late fees for filing GST and TDS returns?",
      answer: "Belated filing of GST returns (GSTR-1/GSTR-3B) incurs a late fee of ₹50 per day (₹20 per day for Nil returns) up to a maximum cap determined by your business turnover tier. Late filing of quarterly TDS returns (Form 24Q/26Q) under Section 234E incurs a non-negotiable fee of ₹200 per day until compliance is met."
    },
    {
      question: "When is a Tax Audit mandatory for businesses under Section 44AB?",
      answer: "Under the Income Tax Act, a Tax Audit is mandatory if your total sales/turnover exceeds ₹1 Crore in a financial year. However, if your cash receipts and cash payments do not exceed 5% of total transactions (meaning 95%+ of transactions are digital or bank-route), this audit threshold limit is extended up to ₹10 Crore."
    },
    {
      question: "What benefits can my startup claim via MSME / Udyam registration?",
      answer: "Registering on the official Udyam portal under Ministry of MSME unlocks interest rate subsidies on bank loans, priority sector lending with collateral-free credits, 50% discount on patent/trademark filings, and strong protection under MSME Samadhaan for delayed payments exceeding 45 days."
    },
    {
      question: "How can individuals and salaried employees save Income Tax in India?",
      answer: "Taxpayers can claim deductions up to ₹1,50,000 under Section 80C (PPF, EPF, ELSS, tuition fees, etc.). Over and above 80C, you can save with Section 80D (health insurance up to ₹25,000 for self/family, ₹50,050 for senior citizen parents), NPS contribution up to ₹50,050 under Section 80CCD(1B), and a flat Standard Deduction of ₹75,050."
    },
    {
      question: "What are the core requirements to incorporate a Pvt Ltd Company / LLP?",
  ...
  return (
    <section id="faq" className="py-16 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-t border-b border-slate-100 relative overflow-hidden">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div>
              ...
              <p className="text-slate-600 text-base leading-relaxed text-justify mb-6">
                To help you move fast, we have compiled official clarification on the most common tax registrations, thresholds, and statutory audits in India. If you need a custom audit or have dynamic filings, our compliance experts are just a click away.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm relative overflow-hidden group">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-slate-900 mb-1">Still confused about limits?</h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-center">
                <span className="block font-display text-2xl font-extrabold text-[#3150A0]">99.9%</span>
                <span className="text-xs text-slate-500 mt-0.5 block">Audit Accuracy</span>
              </div>
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-center">
                <span className="block font-display text-2xl font-extrabold text-[#3150A0]">0%</span>
                <span className="text-xs text-slate-500 mt-0.5 block">Compliance Penalty</span>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
                        isOpen ? 'bg-blue-50 text-[#3150A0]' : 'bg-slate-100 text-slate-500'
                      }`}
                    >
...
function Contact() {
  ...
  return (
    <section id="contact-us" className="py-8 lg:py-10 bg-white relative overflow-hidden border-t border-slate-100">
      {/* Background Decorative Elements */}
      <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3">
        <div className="w-[500px] h-[500px] bg-orange-100/40 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-10 text-justify">
              Whether you're starting up or scaling up, our experts are here to help you navigate through regulatory complexities. Reach out to us today.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#3150A0] uppercase tracking-wider mb-1">Email Us</h4>
                  <a href="mailto:info@makeeazy.in" className="text-lg text-slate-600 hover:text-blue-600 transition-colors">
                    info@makeeazy.in
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#3150A0] uppercase tracking-wider mb-1">Call Us</h4>
                  <a href="tel:+919992819995" className="text-lg text-slate-600 hover:text-orange-500 transition-colors">
                    +91 9992 81 9995
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-[#3150A0] uppercase tracking-wider mb-1">Office</h4>
                  <address className="text-base text-slate-600 not-italic leading-normal">
                    <span className="font-bold text-[#3150A0]">MakeEazy Consultants Private Limited</span><br />
                    Sai Saradhi Nagar, Yellareddyguda, Hyderabad, TG, IN - 500 073<br />
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/50 min-h-[580px] flex flex-col justify-between">
            <h3 className="font-display text-2xl font-bold text-[#3150A0] mb-4">Send us a message</h3>
                ...
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        Thank you for reaching out to us. Our regulatory compliance specialists will contact you shortly.
                      </motion.p>
                    </div>
                  </motion.div>
                ) : (
                    ...
                    <div className="space-y-5">
                      <div className="grid grid-cols-2 gap-5">
                        <div className="space-y-2">
                          ...
                          <input type="text" id="firstName" value={formData.firstName} onChange={handleInputChange} required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" placeholder="Krishiv" />
                        </div>
                        <div className="space-y-2">
                          <label htmlFor="lastName" className="text-sm font-medium text-slate-700">Last Name <span className="text-red-500">*</span></label>
                          <input type="text" id="lastName" value={formData.lastName} onChange={handleInputChange} required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" placeholder="Nandan" />
                        </div>
                      </div>

                      <div className="space-y-2">
                        <label htmlFor="email" className="text-sm font-medium text-slate-700">Email Address <span className="text-red-500">*</span></label>
                        <input type="email" id="email" value={formData.email} onChange={handleInputChange} required className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" placeholder="krishiv@example.com" />
                      </div>

                      <div className="space-y-2">
                        <label htmlFor="phone" className="text-sm font-medium text-slate-700">Phone Number <span className="text-red-500">*</span></label>
                        <input type="tel" id="phone" value={formData.phone} onChange={handleInputChange} required pattern="[0-9\+\-\s]+" className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none" placeholder="+91 99999 99999" />
                      </div>

                      <div className="space-y-2 relative">
                        <label className="text-sm font-medium text-slate-700">Select Service <span className="text-red-500">*</span></label>
                        <div className="relative">
                          ...
                          >
                            <span className={selectedService ? "text-slate-900" : "text-slate-400"}>
                              {selectedService || "Select a service you are interested in"}
                            </span>
                            <ChevronDown className={`w-5 h-5 text-slate-400 transition-transform ${isServiceDropdownOpen ? 'rotate-180' : ''}`} />
                          </button>
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea id="message" value={formData.message} onChange={handleInputChange} required rows={4} className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none resize-none" placeholder="How can we help you?"></textarea>
                      </div>
                    </div>

                    <button type="submit" disabled={status === 'submitting'} className="w-full bg-blue-900 hover:bg-blue-800 text-white px-6 py-4 rounded-xl text-sm font-semibold transition-all shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2 group mt-4 disabled:opacity-70 disabled:cursor-not-allowed">
                      {status === 'submitting' ? 'Sending...' : 'Send Message'}
                      {status !== 'submitting' && <Send className="w-4 h-4 group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />}
                    </button>
                  </motion.form>
                )}
              </AnimatePresence>
    ...
    <footer className="bg-blue-950 text-white border-t border-blue-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 relative z-10">
        <div className="bg-blue-900 rounded-3xl p-8 lg:p-12 border border-blue-800 flex flex-col lg:flex-row items-center justify-between text-center lg:text-left gap-8 shadow-2xl">
          <div>
            ...
            <p className="text-blue-200 text-lg max-w-2xl text-justify">
              Let MakeEazy handle your compliances so you can focus entirely on your vision and scaling up.
            </p>
          </div>
        ...
        <div className="mt-20 pt-10 border-t border-blue-900 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 pl-0 text-sm">
          <div className="col-span-2 lg:col-span-2 pr-8">
            ...
            <p className="text-blue-200/80 leading-normal max-w-xs text-justify">
              MakeEazy Consultants Private Limited. Empowering businesses and individuals with expert audit, accountancy, taxation, and compliance solutions.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-blue-900 flex flex-col md:flex-row justify-between items-center gap-4 text-blue-300 text-xs">
          <p>© {new Date().getFullYear()} - MakeEazy Consultants Private Limited. All rights reserved.</p>
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/company/makeeazy" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LinkedIn">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="https://www.instagram.com/makeeazy.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="https://wa.me/919992819995" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="WhatsApp">
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-24 right-8 p-3 rounded-full bg-orange-500 text-white shadow-lg hover:bg-orange-600 transition-colors z-50 flex items-center justify-center cursor-pointer"
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end pointer-events-none">
      <AnimatePresence>
        {showCallout && (
          ...
          >
            ...
            <div>
              <p className="font-semibold text-slate-900 mb-0.5">Need Expert Help?</p>
      ...
      >
        ...
        <span className="font-semibold text-xs tracking-wide hidden sm:inline-block">Chat with us</span>
      </motion.a>
    </div>
  );
}
